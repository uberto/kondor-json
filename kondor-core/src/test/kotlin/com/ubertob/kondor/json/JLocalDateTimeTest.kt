...
class JLocalDateTimeTest {
    ...
    object JTransactionWithOptionalDate : JObj<TransactionWithOptionalDateTime>() {
        ...
        override fun FieldsValues.deserializeOrThrow(path: NodePath): TransactionWithOptionalDateTime =
